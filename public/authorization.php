...
$authorization->products->add("Jackson 2", "32424242", 1001, 1);
$authorization->products->add("Jackson 3", "32424242", 1002, 2);
$authorization->products->add("Jackson 4", "32424242", 1003, 3);
...
// Transactions
$authorization->transactions->setAmount(10000);
